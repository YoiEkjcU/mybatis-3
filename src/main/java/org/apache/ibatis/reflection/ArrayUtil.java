...
public class ArrayUtil {
     ...
     * <li>{@code thisObj} and {@code thatObj} are arrays with the same component type and equals() method of {@link Arrays} returns <code>true</code> (not deepEquals())</li>
     * </ul>
     * 
    ...
    /**
     * If the {@code obj} is an array, toString() method of {@link Arrays} is called. Otherwise {@link Object#toString()} is called. Returns "null" if {@code obj} is <code>null</code>.
     * 
